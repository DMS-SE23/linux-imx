...
int adv_vpm_cmd_exe_suspend(void){//ask vpm to execute suspend from android ui
	struct adv_vpm_data tp={0};
	tp.wlen = 2;
	tp.rlen = 0;
	tp.data[0] = 0x0a;
...
int adv_vpm_cmd_off_mode(void){//ask vpm to change mode to off mode
	struct adv_vpm_data tp={0};
	tp.wlen = 2;
	tp.rlen = 0;
	tp.data[0] = 0x0a;
...
int adv_vpm_cmd_os_resumeon_ping(void){// OS resume/on successful
	struct adv_vpm_data tp={0};
	tp.wlen = 2;
	tp.rlen = 0;
	tp.data[0] = 0x0d;
